                ...
                {formSubmitted ? (
                    ...
                    <div>
                        ...
                        <div className="mb-3">
                            ...
                            {/* Hidden inputs to include in email */}
                            <input type="hidden" name="startDateTime" value={formData.startDateTime} />
                            <input type="hidden" name="endDateTime" value={formData.endDateTime} />
                        </div>
